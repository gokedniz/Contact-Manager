...
public class ActivityLogDAO {
     ...
     * 
    * <p>Note: SQLExceptions are handled internally and logged; the method does not throw
    * checked SQLExceptions to callers.</p>
     */
    ...
    * checked SQLExceptions to callers.</p>
     ...
     * for NULL user_ids. Results are sorted by log_id in specified order.</p>
     * 
     * @param usernameFilter Optional filter for username (LIKE pattern matching). Pass null or empty to skip.
     * @param actionFilter Optional filter for action type (LIKE pattern matching). Pass null or empty to skip.
     ...
     * 
    * <p>Note: SQLExceptions are handled internally and logged; the method does not throw
    * checked SQLExceptions to callers. Returns an empty list on error.</p>
     */
